    ...
    return (
        <div className={ `flex justify-between items-center bg-blue-900 ${ showTodo ? "rounded-t-xl" : "rounded-xl"} py-2 px-6 `} onClick={onClick}>
            ...
            <div className="flex justify-around items-center" >
                ...
                <div  className="flex relative text-slate-300 items-center p-2 group transform transition-transform duration-300 hover:scale-125 hover:text-red-500 " onClick={(e) => e.stopPropagation()}>
